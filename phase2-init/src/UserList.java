...
import java.util.*;
	...
	public class UserList implements java.io.Serializable {
		...
		// iterate through each user's group list to check the existence of a group
		public synchronized boolean checkGroup(String groupname) {
			String username;
			Set<String> users = list.keySet();
			Iterator<String> itr = users.iterator();
			while (itr.hasNext()) { 
				username = itr.next();
				ArrayList<String> groups = getUserGroups(username);
