...
public interface GroupClientInterface
{
     ...
     * @param fileServerName The file server ("host:port") that the user intends to use for file management
     *
     * @return A UserToken describing the permissions of "username."
     *         If this user does not exist, a null value will be returned.
     *
     */
    public UserToken getToken(final String username, final String fileServerName);
